...
export default class PipeSelections {
  ...
  constructor(indexer, executeInReplFunction, sendAllToReplFunction) {
    this.indexer = indexer;
    this.executeInRepl = executeInReplFunction;
    this.sendAllToRepl = sendAllToReplFunction;
  ...
  applyToEditor(code) {
    ...
    this.sendAllToRepl(proc, [
      imports,
      prelude,
      JSON.stringify(selectedTexts) + maybeConcat + '\n |> ' + code
    ]);
  }
