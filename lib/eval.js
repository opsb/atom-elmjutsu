...
export default class Eval {
  ...
  constructor(indexer) {
    this.pipeSelections = new PipeSelections(indexer, this.executeInRepl.bind(this), sendAllToRepl);
  }
...
function sendAllToRepl(proc, codes) {
  proc.stdin.write(codes.map(formatCode).join('\n'));
}
